...
export const adminPageData: AdminPageResponseDto = {
  ...
  chapters: [
    ...
    { id: "ch-opm-195", title: "195. Bölüm", series: "One Punch Man", status: "taslak" }
  ],
  users: [
    { id: "user-og3n", username: "o_g3n_admin", role: "admin", isBanned: false },
    { id: "user-kai", username: "kai_reader", role: "uye", isBanned: false },
    { id: "user-mod", username: "mod_sena", role: "editor", isBanned: false }
  ],
  comments: [
    { id: "c1", author: "kai_reader", content: "Bu bölüm efsaneydi!", chapterRef: "JJK #241" },
    { id: "c2", author: "voidline", content: "Spoiler içeriyor.", chapterRef: "Berserk #1" }
  ]
};
